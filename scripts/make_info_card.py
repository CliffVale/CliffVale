...
# ===========================================================================
HOST = "CliffVale"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "M.Tech Biomedical Engg @ IIT Delhi"),
    ("kv", "Focus", "Computational Biology & Drug Discovery"),
    ("kv", "Interests", "Molecular Docking, PK/PD Modeling"),
    ("kv", "Location", "New Delhi, India"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, R, Bash"),
    ("kv", "Tools", "AutoDock, HDOCK, GROMACS"),
    ("kv", "ML/AI", "Scikit-learn, TensorFlow, PyTorch"),
    ("kv", "Bioinfo", "RDKit, BioPython, PyMOL"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "De novo aptamer design for wearable CRP biosensor"),
    ("bul", "99.75% accuracy in gene expression prediction"),
    ("bul", "97.8% accuracy in lung cancer risk assessment"),
]
